...
public final class Preconditions {
    ...
    public static <T> T checkNotNull(T reference, @Nullable String errMsg,
                                     @Nullable Object... errorMessageArgs) {
        if(reference == null) {
            throw new NullPointerException(format(errMsg, errorMessageArgs));
        } else {
            return reference;
        }
    }
    ...
    private static String badElementIndex(int index, int size, String desc) {
        if(index < 0) {
            ...
            throw new IllegalArgumentException((new StringBuilder(26))
    ...
    private static String badPositionIndexes(int start, int end, int size) {
        return start >= 0 && start <= size?(end >= 0 && end <= size?format(
                ...
                new Object[]{Integer.valueOf(end), Integer.valueOf(start)}):badPositionIndex(
                        end, size, "end index")):badPositionIndex(start, size,
                "start index");
    }
